...
const mainConfig = require('../config/webpack.electron.config');
...
function startRenderer() {
  return new Promise((resolve, reject) => {
    ...
    compiler.hooks.compilation.tap('HtmlWebpackPluginAfterEmit', (compilation) => {
      HtmlWebpackPlugin.getHooks(compilation).afterEmit.tapAsync('AfterPlugin', (data, cb) => {
...
function startMain() {
  return new Promise((resolve, reject) => {
    mainConfig.entry.main = [path.join(__dirname, '../src-electron/index.dev.js')].concat(
